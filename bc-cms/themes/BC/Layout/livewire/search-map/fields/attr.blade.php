    ...
    @if($attr)
        <div class="filter-item">
            <div class="form-group">
                <i class="field-icon {{$attr_icon ?? 'icofont-yacht' }}"></i>
                <div class="form-content" wire:ignore>
                    ...
                    <div class="smart-search">
                        ...
                        <input type="hidden" class="child_id attr_id_hidden_input" data-attr-id="{{$attr->id}}" name="attrs[{{$attr->id}}][]" value="{{$query_attrs[$attr->id][0] ?? ''}}">
                    </div>
                </div>
            </div>
        </div>
