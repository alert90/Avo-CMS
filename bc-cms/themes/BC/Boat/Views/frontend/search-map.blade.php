<div class="bc_search_tour bc_search_boat">
    <h1 class="d-none">
        {{ setting_item_with_lang('boat_page_search_title') }}
    </h1>
    <div class="bc_form_search_map b-relative">
        @livewire('boat::filter-for-map')
    </div>
    <div class="bc_search_map {{ setting_item_with_lang('boat_layout_map_option', false, 'map_left') }}">
