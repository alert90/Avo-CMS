<div class="bc_single_book_wrap @if (setting_item('event_enable_inbox')) has-vendor-box @endif">
                        ...
                        <div class="form-group form-guest-search" v-for="(type,index) in ticket_types">
                            <div class="guest-wrapper d-flex justify-content-between align-items-center"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="render check-in-render">@{{ type.display_price }} {{ __('per ticket') }}
                                    </div>
                                </div>
