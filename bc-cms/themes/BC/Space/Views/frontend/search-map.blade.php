...
@push('css')
    <link href="{{ asset('themes/bc/dist/frontend/module/space/css/space.css?_ver=' . config('app.asset_version')) }}" rel="stylesheet">
...
@section('content')
    <div class="bc_search_tour bc_search_space">
        ...
        <div class="bc_search_map {{ setting_item_with_lang('space_layout_map_option', false, 'map_left') }}">
