...
<head>
    <meta charset="UTF-8"/>
    <title>Avo - All-in-One Booking Solution</title>
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="https://x.com/ennexica" target="_blank">Support</a>
                            <a target="_blank" class="dropdown-item" href="https://avoguide.com">Documentation</a>
                    ...
                    <ul class="menu">
                        ...
                        <li>
                            <a target="_blank" href="https://sandc.co.tz">Support</a>
                        </li>
                        <li>
                            <a target="_blank" href="https://sandc.co.tz">Documentation</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Avo</span> is super<br />fast and easy <img src="{{url('landing/img/hand.svg')}}" /></h3>
        <a target="_blank"  href="{{config('landing.item_url')}}" class="btn-buynow">BUY NOW</a>
        <div class="social">
            <span>FOLLOW US</span>
            <ul>
