...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Avo'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right">
                        {{date('Y')}} &copy; {{__('Avo by')}} <a
                            href="{{__('https://cyberwiz.world')}}" target="_blank"
                        >{{__('Cyberwiz')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://sandc.co.tz')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://x.com/ennexica')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
