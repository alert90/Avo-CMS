...
@section('content')
    <form action="{{ route('food.admin.store', ['id' => $row->id ?? 0, 'lang' => request()->query('lang')]) }}"
        method="post">
        @csrf
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{ $row->id ? __('Edit: ') . $row->title : __('Add new food') }}</h1>
                    @if ($row->slug)
                        <p class="item-url-demo">{{ __('Permalink') }}: {{ url('food') }}/<a href="#"
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        @include('Food::admin.food.content')
                        @include('Food::admin.food.pricing')
                        @include('Food::admin.food.location')
                    ...
                    <div class="col-md-3">
                        ...
                        @if (is_default_lang())
                            ...
                            @include('Food::admin.food.attributes')
                            <div class="panel">
