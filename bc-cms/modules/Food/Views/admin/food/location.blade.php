                    ...
                    <div class="g-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="map_zoom" class="form-control"
                                value="{{ $row->map_zoom ?? '8' }}" onkeydown="return food.key !== 'Enter';">
                        </div>
                    </div>
                </div>
            </div>
