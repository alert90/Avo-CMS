<div class="panel">
    <div class="panel-title"><strong>{{__("Food Content")}}</strong></div>
    <div class="panel-body">
        ...
        @if(is_default_lang())
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Preparation Time (minutes)")}}</label>
                        <input type="number" name="start_time" class="form-control" value="{{$row->start_time}}" placeholder="{{__("Ex: 30")}}">
                        <small>
                            {{ __("Preparation time in minutes") }}
                        </small>
                    </div>
                </div>
