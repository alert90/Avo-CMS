    ...
    <div class="panel-body">
        @if(is_default_lang())
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Food Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Sale Price")}}</label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="{{$row->sale_price}}" placeholder="{{__("Food Sale Price")}}">
            ...
            <div class="form-group-item @if( $row->getBookingType()== "time_slot") d-none @endif" >
                ...
                <div class="g-items">
                    @if(!empty($row->ticket_types) && is_array($row->ticket_types))
        ...
        <div class="form-group-item @if(!is_default_lang()) d-none @endif" data-condition="enable_extra_price:is(1)">
            ...
            <div class="g-items">
                @if(!empty($row->extra_price) && is_array($row->extra_price))
        ...
        @if(is_default_lang() and (!empty(setting_item("food_allow_vendor_can_add_service_fee")) or is_admin()))
            <hr>
            ...
            <div class="form-group-item" data-condition="enable_service_fee:is(1)">
                ...
                <div class="g-items">
                    <?php  $languages = \Modules\Language\Models\Language::getActive();?>
                    @if(!empty($service_fee = $row->service_fee) && is_array($service_fee))
