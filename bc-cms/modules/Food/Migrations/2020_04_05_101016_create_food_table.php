...
class CreateFoodTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bc_foods', function (Blueprint $table) {
        ...
        Schema::create('bc_food_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_food_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bc_food_dates', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bc_foods');
        Schema::dropIfExists('bc_food_translations');
        Schema::dropIfExists('bc_food_dates');
        Schema::dropIfExists('bc_food_term');
    }
}
