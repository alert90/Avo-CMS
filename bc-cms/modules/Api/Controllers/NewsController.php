...
class NewsController extends Controller
{
    public function search(Request $request){
        $locale = $request->get('set_lang', app()->getLocale());
        ...
        return $this->sendSuccess(
            [
                ...
                'data'=>$rows->map(function($row) use ($locale) {
                    // Pass the locale to dataForApi method
                    return $row->dataForApi(false, $locale);
                }),
            ]
        );
    }
    ...
    public function detail($id = '', Request $request)
    {
        ...
        return $this->sendSuccess([
            'data'=>$row->dataForApi(true, $locale)
        ]);
    }
}