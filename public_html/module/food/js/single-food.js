(function ($) {
    new Vue({
        ...
        watch:{
            ...
            start_date(){
                ...
                for (var ix in me.allFoods) {
                    var item = me.allFoods[ix];
        ...
        mounted(){
            ...
            var options = {
                ...
                isInvalidDate:function (date) {
                    for(var k = 0 ; k < me.allFoods.length ; k++){
                        var item = me.allFoods[k];
            ...
            this.$nextTick(function () {
                $(this.$refs.start_date).daterangepicker(options).on('apply.daterangepicker',
                    ...
                    .on('update-calendar',function (e,obj) {
                        me.fetchFoods(obj.leftCalendar.calendar[0][0], obj.leftCalendar.calendar[5][6])
                    });
            });
        },
        methods:{
    ...
    $(".bc_detail_food .g-faq .item .header").click(function () {
